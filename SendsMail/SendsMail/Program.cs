...
namespace SendsMail
{
    class Program
    {
        ...
        private static void DurableTask()
        {
            ...
            OrchestrationInstance instance = taskHubClient.CreateOrchestrationInstance(typeof(MailOrchestration), "Hello");

            taskHubWorker.AddTaskOrchestrations(typeof(MailOrchestration));
            taskHubWorker.AddTaskActivities(new CredentialTask(), new SendMailTask());
            taskHubWorker.Start();
