...
namespace SendsSMS
{
    class Program
    {
        ...
        private static void DurableTask()
        {
            ...
            OrchestrationInstance instance = taskHubClient.CreateOrchestrationInstance(typeof(SMSOrchestration), "Hello");

            taskHubWorker.AddTaskOrchestrations(typeof(SMSOrchestration));
            taskHubWorker.AddTaskActivities(new SMSCredentialTask(), new SendSMSTask());
            taskHubWorker.Start();
