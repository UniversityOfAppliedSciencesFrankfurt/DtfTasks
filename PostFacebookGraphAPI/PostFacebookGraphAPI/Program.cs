...
namespace PostFacebookGraphAPI
{
    class Program
    {
        ...
        private static void DurableTask()
        {
            ...
            OrchestrationInstance instance = taskHubClient.CreateOrchestrationInstance(typeof(FbTaskOrchestration), "Hello");

            taskHubWorker.AddTaskOrchestrations(typeof(FbTaskOrchestration));
            taskHubWorker.AddTaskActivities(new AccessTokenTask(), new PostTask());
            taskHubWorker.Start();
